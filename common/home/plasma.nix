...
{ inputs, ... }:
{
  ...
  programs.plasma = {
    ...
    configFile = {
      ...
      "kwinrc"."Tiling/37021c24-541d-5305-99d3-402dd1ef974b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/42ab4d16-8f13-5ad9-8a7c-7b681151df5a"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
